    ...
    useEffect(() => {
        const createPaymentIntent = async () => {
            try {
              ...
              const response = await fetch('https://dogsmarketserver.onrender.com/stripe/create-payment-intent', {
                method: "POST",
      ...
      useEffect(() => {
        const fetchConfig = async () => {
          try {
            const response = await fetch('https://dogsmarketserver.onrender.com/config');
