    ...
    useEffect(() => {
        const createPaymentIntent = async () => {
            try {
              ...
              const response = await fetch('https://dogstoreserver.onrender.com/stripe/create-payment-intent', {
                method: "POST",
      ...
      useEffect(() => {
        const fetchConfig = async () => {
          try {
            const response = await fetch('https://dogstoreserver.onrender.com/config');
